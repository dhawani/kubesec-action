...
const kubesec_1 = __webpack_require__(793);
function run() {
...
Object.defineProperty(exports, "__esModule", { value: true });
const restm = __importStar(__webpack_require__(874));
function scan(file, url = 'http://localhost:8080/scan') {
    return __awaiter(this, void 0, void 0, function* () {
        const client = new restm.HttpClient('Github Kubescan Action');
        const response = yield client.post(url, file);
        if (response.message.statusCode === 200) {
            const message = yield response.readBody();
